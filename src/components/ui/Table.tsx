...
export function Table({ className, ...props }: ComponentProps<"table">) {
  return (
    <div className="w-full overflow-x-auto rounded-2xl border border-border/70 bg-panel/40">
...
export function THead(props: ComponentProps<"thead">) {
  return <thead className="bg-bg/30 text-xs uppercase tracking-widest text-muted" {...props} />;
}

export function TRow(props: ComponentProps<"tr">) {
  return <tr className="border-t border-border/60" {...props} />;
}
